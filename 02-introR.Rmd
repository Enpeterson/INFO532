...
knitr::opts_chunk$set(cache = TRUE, message =F, warning =F)
 knitr::include_graphics("fig/firstcommand.png")
```
...
```{r echo = F, fig.align='center', out.width='70%', message = F, warning = F}
knitr::opts_chunk$set(cache = TRUE, message =F, warning =F)
knitr::include_graphics("fig/xassign.jpg")
```
...
```{r echo = F, fig.align='center', out.width='70%', message = F, warning = F}
knitr::opts_chunk$set(cache = TRUE, message =F, warning =F)
knitr::include_graphics("fig/workflow.jpg")
```
...
knitr::opts_chunk$set(cache = TRUE, message =F, warning =F)
knitr::include_graphics("fig/markdown.jpg")
```
...
```{r echo = F, fig.align='center', out.width='99%', message = F, warning = F}
knitr::opts_chunk$set(cache = TRUE, message =F, warning =F)
knitr::include_graphics("fig/codechunk.jpg")
```
